...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Expiry, method_decorators= method_decorators)
    api.expose_object(database.models.Fruit, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.SaleDetail, method_decorators= method_decorators)
    api.expose_object(database.models.Supplier, method_decorators= method_decorators)
    api.expose_object(database.models.SupplierFruit, method_decorators= method_decorators)
    return api
