...
@Component({
  selector: 'Expiry-home',
  templateUrl: './Expiry-home.component.html',
  styleUrls: ['./Expiry-home.component.scss']
})
export class ExpiryHomeComponent implements AfterViewInit {
