...
@Component({
  selector: 'SaleDetail-home',
  templateUrl: './SaleDetail-home.component.html',
  styleUrls: ['./SaleDetail-home.component.scss']
})
export class SaleDetailHomeComponent implements AfterViewInit {
