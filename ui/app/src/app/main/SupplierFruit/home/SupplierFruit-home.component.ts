...
@Component({
  selector: 'SupplierFruit-home',
  templateUrl: './SupplierFruit-home.component.html',
  styleUrls: ['./SupplierFruit-home.component.scss']
})
export class SupplierFruitHomeComponent implements AfterViewInit {
